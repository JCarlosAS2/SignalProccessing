...
uses
  ...
  FilterIIRBSBessel, Math, types, TACustomSeries;
...
begin
  ...
  Application.Title:= 'Filter Band Stop Bessel Example';
...
begin
  FilterIIRBSBessel1.Gain:= FloatSpinEditGain.Value;
end;

procedure TForm1.FloatSpinEditFreqCut1Change(Sender: TObject);
begin
    FilterIIRBSBessel1.FreqCut1:= FloatSpinEditFreqCut1.Value;
end;

procedure TForm1.FloatSpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRBSBessel1.SampleRate:=FloatSpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
...
begin
  FilterIIRBSBessel1.FreqCut2:=FloatSpinEditFreqCut2.Value;
end;
...
begin
   FilterIIRBSBessel1.Order:= SpinEditOrder.Value;
end;
...
begin
  for I:= 1 to 5 do
  begin
    T:= Timer1.Tag / FilterIIRBSBessel1.SampleRate;
 ...
 Timer1.Enabled:=false;
    ...
    Series2.AddXY(T, FilterIIRBSBessel1.Filter(V), '', clRed);
