...
begin
  ...
  Application.Title:= 'Filter Band Stop Chebyshev Example' ;
...
begin
    FilterIIRBSChebyshev1.FreqCut1:= FloatSpinEditFreqCut1.Value;
end;
...
begin
   FilterIIRBSChebyshev1.FreqCut2:= FloatSpinEditFreqCut2.Value;
end;

procedure TForm1.FloatSpinEditGainChange(Sender: TObject);
begin
     FilterIIRBSChebyshev1.Gain:= FloatSpinEditGain.Value;
end;

procedure TForm1.FloatSpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRBSChebyshev1.SampleRate:=FloatSpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
...
begin
    FilterIIRBSChebyshev1.Ripple:= seRipple.Value / 10;
end;

procedure TForm1.SpinEditOrderChange(Sender: TObject);
begin
    FilterIIRBSChebyshev1.Order:= SpinEditOrder.Value;
end;
...
begin
  ...
  begin
    ...
    Tmp := FilterIIRBSChebyshev1.Filter(V);
