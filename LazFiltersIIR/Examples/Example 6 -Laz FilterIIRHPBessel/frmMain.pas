...
uses
  ...
  FilterIIRHPBessel, Math, types, TACustomSeries;
...
begin
  ...
  Application.Title:= 'Filter High Pass Bessel Example';
...
begin
  FilterIIRHPBessel1.Gain:= FloatSpinEditGain.Value;
end;

procedure TForm1.FloatSpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRHPBessel1.SampleRate:=FloatSpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
...
begin
    FilterIIRHPBessel1.FreqCut1:= FloatSpinEditFreqCut1.Value;
end;
...
begin
   FilterIIRHPBessel1.Order:= SpinEditOrder.Value;
end;
...
begin
  for I:= 1 to 5 do
  begin
    T:= Timer1.Tag / FilterIIRHPBessel1.SampleRate;
 ...
 Timer1.Enabled:=false;
    ...
    Series2.AddXY(T, FilterIIRHPBessel1.Filter(V), '', clRed);
