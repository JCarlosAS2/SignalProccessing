...
uses
  ...
  Menus, Math,
  Filter, FilterIIR, UType, Spin, FilterIIRBP, FilterIIRBPBessel;
...
begin
  FilterIIRBPBessel1.Order:= SpinEditOder.Value;
end;

procedure TfmMain.SpinEditFreqCut1Change(Sender: TObject);
begin
  FilterIIRBPBessel1.FreqCut1:= SpinEditFreqCut1.Value;
end;
...
begin
   FilterIIRBPBessel1.FreqCut2:= SpinEditFreqCut2.Value;
end;

procedure TfmMain.SpinEditGainChange(Sender: TObject);
begin
   FilterIIRBPBessel1.Gain:= SpinEditGain.Value;
end;

procedure TfmMain.SpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRBPBessel1.SampleRate:=SpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
