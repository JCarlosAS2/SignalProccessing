...
uses
  ...
  Menus, Math, 
  Filter, FilterIIR, UType, Spin, FilterIIRBP, FilterIIRBPButterworth;
...
begin
  FilterIIRBPButterworth1.Order:= SpinEditOder.Value;
end;

procedure TfmMain.SpinEditFreqCut1Change(Sender: TObject);
begin
  FilterIIRBPButterworth1.FreqCut1:= SpinEditFreqCut1.Value;
end;
...
begin
   FilterIIRBPButterworth1.FreqCut2:= SpinEditFreqCut2.Value;
end;

procedure TfmMain.SpinEditGainChange(Sender: TObject);
begin
   FilterIIRBPButterworth1.Gain := SpinEditGain.Value;
end;

procedure TfmMain.SpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRBPButterworth1.SampleRate:=SpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
