...
uses
  ...
  FilterIIRHPButterworth, Math, types, TACustomSeries;
...
begin
  FilterIIRHPButterworth1.Gain:= FloatSpinEditGain.Value;
end;

procedure TForm1.FloatSpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRHPButterworth1.SampleRate:=FloatSpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
...
begin
    FilterIIRHPButterworth1.FreqCut1:= FloatSpinEditFreqCut1.Value;
end;
...
begin
   FilterIIRHPButterworth1.Order:= SpinEditOrder.Value;
end;
...
begin
  for I:= 1 to 5 do
  begin
    T:= Timer1.Tag / FilterIIRHPButterworth1.SampleRate;
 ...
 Timer1.Enabled:=false;
    ...
    Series2.AddXY(T, FilterIIRHPButterworth1.Filter(V), '', clRed);
