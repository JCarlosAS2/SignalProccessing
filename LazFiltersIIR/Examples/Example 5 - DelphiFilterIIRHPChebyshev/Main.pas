...
uses
  ...
  Menus, Math, 
  Filter, FilterIIR, UType, Spin, FilterIIRHP, FilterIIRHPChebyshev;
...
var S: String;
begin
  FilterIIRHPChebyshev1.Ripple:= tbFilterRipple.Position / 10;
  Str(FilterIIRHPChebyshev1.Ripple:4:1, S);
...
begin
  ...
  begin
    ...
    Series2.AddXY(T, FilterIIRHPChebyshev1.Filter(V), '', clRed);
...
begin
  FilterIIRHPChebyshev1.Order:= SpinEditOder.Value;
end;

procedure TfmMain.SpinEditFreqCut1Change(Sender: TObject);
begin
  FilterIIRHPChebyshev1.FreqCut1:= SpinEditFreqCut1.Value;
end;
...
begin
  FilterIIRHPChebyshev1.Gain:= SpinEditGain.Value;
end;

procedure TfmMain.SpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRHPChebyshev1.SampleRate:=SpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
