...
uses
  ...
  FilterIIRBPBessel, Math, types, TACustomSeries;
...
begin
  ...
  Application.Title:= 'Filter Band Pass Bessel Example';
...
begin
  FilterIIRBPBessel1.Gain:= FloatSpinEditGain.Value;
end;

procedure TForm1.FloatSpinEditFreqCut1Change(Sender: TObject);
begin
    FilterIIRBPBessel1.FreqCut1:= FloatSpinEditFreqCut1.Value;
end;
...
begin
  ...
  FilterIIRBPBessel1.SampleRate:=FloatSpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
...
begin
  FilterIIRBPBessel1.FreqCut2:=FloatSpinEditFreqCut2.Value;
end;
...
begin
   FilterIIRBPBessel1.Order:= SpinEditOrder.Value;
end;
...
begin
  for I:= 1 to 5 do
  begin
    T:= Timer1.Tag / FilterIIRBPBessel1.SampleRate;
 ...
 Timer1.Enabled:=false;
    ...
    Series2.AddXY(T, FilterIIRBPBessel1.Filter(V), '', clRed);
