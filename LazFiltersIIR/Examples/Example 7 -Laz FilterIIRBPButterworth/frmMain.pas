...
uses
  ...
  FilterIIRBPButterworth, Math, types, TACustomSeries;
...
begin
  ...
  Application.Title:= 'Filter Band Pass Butterworth Example';
...
begin
  FilterIIRBPButterworth1.Gain:= FloatSpinEditGain.Value;
end;

procedure TForm1.FloatSpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRBPButterworth1.SampleRate:=FloatSpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
...
begin
    FilterIIRBPButterworth1.FreqCut1:= FloatSpinEditFreqCut1.Value;
end;

procedure TForm1.FloatSpinEditFreqCut2Change(Sender: TObject);
begin
    FilterIIRBPButterworth1.FreqCut2:= FloatSpinEditFreqCut2.Value;
end;
...
begin
   FilterIIRBPButterworth1.Order:= SpinEditOrder.Value;
end;
...
begin
  for I:= 1 to 5 do
  begin
    T:= Timer1.Tag / FilterIIRBPButterworth1.SampleRate;
 ...
 Timer1.Enabled:=false;
    ...
    Series2.AddXY(T, FilterIIRBPButterworth1.Filter(V), '', clRed);
