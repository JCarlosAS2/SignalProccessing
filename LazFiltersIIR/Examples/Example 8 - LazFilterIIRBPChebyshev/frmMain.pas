...
uses
  ...
  TATransformations, TADbSource, TAFuncSeries,
  FilterIIRBPChebyshev, Math, types;
...
begin
  ...
  Application.Title:= 'Filter Band Pass Chebyshev Example' ;
...
begin
    FilterIIRBPChebyshev1.FreqCut1:= FloatSpinEditFreqCut1.Value;
end;
...
begin
   FilterIIRBPChebyshev1.FreqCut2:= FloatSpinEditFreqCut2.Value;
end;

procedure TForm1.FloatSpinEditGainChange(Sender: TObject);
begin
     FilterIIRBPChebyshev1.Gain:= FloatSpinEditGain.Value;
end;

procedure TForm1.FloatSpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRBPChebyshev1.SampleRate:=FloatSpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
...
begin
  FilterIIRBPChebyshev1.Ripple:= seRipple.Value / 10;
end;

procedure TForm1.SpinEditOrderChange(Sender: TObject);
begin
    FilterIIRBPChebyshev1.Order:= SpinEditOrder.Value;
end;
...
begin
  ...
  for I:= 1 to 5 do
  begin
    T:= Timer1.Tag / FilterIIRBPChebyshev1.SampleRate;
    ...
    Tmp := FilterIIRBPChebyshev1.Filter(V);
