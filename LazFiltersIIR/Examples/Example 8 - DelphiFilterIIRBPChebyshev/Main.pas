...
uses
  ...
  Menus, Math, 
  Filter, FilterIIR, UType, Spin, FilterIIRBP, FilterIIRBPChebyshev;
...
var S: String;
begin
  FilterIIRBPChebyshev1.Ripple:= tbFilterRipple.Position / 10;
  Str(FilterIIRBPChebyshev1.Ripple:4:1, S);
...
begin
  ...
  begin
    ...
    Series2.AddXY(T, FilterIIRBPChebyshev1.Filter(V), '', clRed);
...
begin
  FilterIIRBPChebyshev1.Order:= SpinEditOder.Value;
end;

procedure TfmMain.SpinEditFreqCut1Change(Sender: TObject);
begin
  FilterIIRBPChebyshev1.FreqCut1:= SpinEditFreqCut1.Value;
end;
...
begin
   FilterIIRBPChebyshev1.FreqCut2:= SpinEditFreqCut2.Value;
end;

procedure TfmMain.SpinEditGainChange(Sender: TObject);
begin
   FilterIIRBPChebyshev1.Gain:= SpinEditGain.Value;
end;

procedure TfmMain.SpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRBPChebyshev1.SampleRate:=SpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
