...
uses
  ...
  Menus, Math, 
  Filter, FilterIIR, UType, Spin, FilterIIRLP, FilterIIRLPChebyshev;
...
var S: String;
begin
  FilterIIRLPChebyshev1.Ripple:= tbFilterRipple.Position / 10;
  Str(FilterIIRLPChebyshev1.Ripple:4:1, S);
...
begin
  ...
  begin
    ...
    Series2.AddXY(T, FilterIIRLPChebyshev1.Filter(V), '', clRed);
...
begin
  FilterIIRLPChebyshev1.Order:= SpinEditOder.Value;
end;

procedure TfmMain.SpinEditFreqCut1Change(Sender: TObject);
begin
  FilterIIRLPChebyshev1.FreqCut1:= SpinEditFreqCut1.Value;
end;
...
begin
  FilterIIRLPChebyshev1.Gain:= SpinEditGain.Value;
end;

procedure TfmMain.SpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRLPChebyshev1.SampleRate:=SpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
