...
uses
  ...
  FilterIIRBSButterworth, Math, types, TACustomSeries;
...
begin
  FilterIIRBSButterworth1.Gain:= FloatSpinEditGain.Value;
end;

procedure TForm1.FloatSpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRBSButterworth1.SampleRate:=FloatSpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
...
begin
    FilterIIRBSButterworth1.FreqCut1:= FloatSpinEditFreqCut1.Value;
end;

procedure TForm1.FloatSpinEditFreqCut2Change(Sender: TObject);
begin
    FilterIIRBSButterworth1.FreqCut2:= FloatSpinEditFreqCut2.Value;
end;
...
begin
   FilterIIRBSButterworth1.Order:= SpinEditOrder.Value;
end;
...
begin
  for I:= 1 to 5 do
  begin
    T:= Timer1.Tag / FilterIIRBSButterworth1.SampleRate;
 ...
 Timer1.Enabled:=false;
    ...
    Series2.AddXY(T, FilterIIRBSButterworth1.Filter(V), '', clRed);
