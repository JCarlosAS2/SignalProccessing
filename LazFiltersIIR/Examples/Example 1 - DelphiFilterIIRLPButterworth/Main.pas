...
uses
  ...
  Menus, Math,
  Filter, FilterIIR, UType, Spin,
  FilterIIRLP, FilterIIRLPButterworth;
...
begin
  FilterIIRLPButterworth1.Order:= SpinEditOder.Value;
end;

procedure TfmMain.SpinEditFreqCut1Change(Sender: TObject);
begin
  FilterIIRLPButterworth1.FreqCut1:= SpinEditFreqCut1.Value;
end;
...
begin
  FilterIIRLPButterworth1.Gain:= SpinEditGain.Value;
end;

procedure TfmMain.SpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterIIRLPButterworth1.SampleRate:=SpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
