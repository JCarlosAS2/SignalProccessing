...
case CBoxWind.ItemIndex of
    0 :   DCT1.WgtWin := WinRectangular1;// fwRectangle;
    1 :   DCT1.WgtWin := WinTriangle1;
    2 :   DCT1.WgtWin := WinGauss1;
    3 :   DCT1.WgtWin := WinBlackman1;
    4 :   DCT1.WgtWin := WinCos2_1;
    5 :   DCT1.WgtWin := WinHamming1;
    6 :   DCT1.WgtWin := WinHanning1;
    7 :   DCT1.WgtWin := WinKaiser1;
    8 :   DCT1.WgtWin := WinLanczos1;
    9 :   DCT1.WgtWin := WinTukey1;
    10:   DCT1.WgtWin := WinBlackManHarris1;
    11:   DCT1.WgtWin := WinFlatTop1;
    else Begin
...
begin
 ...
 for i:=1 to   DCT1.SpectrumSize do
  begin
...
for i:=1 to (  DCT1.SpectrumSize) do
  begin
     case RGSpecType.ItemIndex of
        0 : y :=   DCT1.Magnitude[i];
        1 : y :=   DCT1.PowerSpec[i];
        2 : y :=   DCT1.Phase[i];
        3 : y :=   DCT1.FourSerCosCoeff[i];
        4 : y :=   DCT1.FourSerSinCoeff[i];
        5 : y :=   DCT1.RealSpec[i+1];
        6 : y :=   DCT1.ImagSpec[i+1];
     end;
