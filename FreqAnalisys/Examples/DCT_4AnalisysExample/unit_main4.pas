...
uses
  ...
  UDCT, UDCT_1, UDCT_2, UDCT_3, UDCT_4, ASWinTriangle, ASWinGauss,
  ASWinRectangular, ASWinBlackman, ASWinHamming, ASWinCos2, ASWinHanning,
  ASWinLanczos, ASWinTukey, ASWinKaiser, ASWinBlackmanHarris, ASWinFlatTop;
...
case CBoxWind.ItemIndex of
    0 :  DCT_4_1.WgtWin := WinRectangular1;// fwRectangle;
    1 :  DCT_4_1.WgtWin := WinTriangle1;
    2 :  DCT_4_1.WgtWin := WinGauss1;
    3 :  DCT_4_1.WgtWin := WinBlackman1;
    4 :  DCT_4_1.WgtWin := WinCos2_1;
    5 :  DCT_4_1.WgtWin := WinHamming1;
    6 :  DCT_4_1.WgtWin := WinHanning1;
    7 :  DCT_4_1.WgtWin := WinKaiser1;
    8 :  DCT_4_1.WgtWin := WinLanczos1;
    9 :  DCT_4_1.WgtWin := WinTukey1;
    10:  DCT_4_1.WgtWin := WinBlackManHarris1;
    11:  DCT_4_1.WgtWin := WinFlatTop1;
    else Begin
...
begin
 ...
 for i:=1 to  DCT_4_1.SpectrumSize do
  begin
  {  y := 100*(sin(0.01*i*(100-SbFreq1.Position))  +
    ...
    y := (i) + 50*cos((i)*2*pi/40);
     ...
     DCT_4_1.RealSpec[i] := y;

  end;

    DCT_4_1.InverseTransform;
...
for i:=1 to ( DCT_4_1.SpectrumSize) do
  begin
     case RGSpecType.ItemIndex of
        0 : y :=  DCT_4_1.Magnitude[i];
        1 : y :=  DCT_4_1.PowerSpec[i];
        2 : y :=  DCT_4_1.Phase[i];
        3 : y :=  DCT_4_1.FourSerCosCoeff[i];
        4 : y :=  DCT_4_1.FourSerSinCoeff[i];
        5 : y :=  DCT_4_1.RealSpec[i+1];
        6 : y :=  DCT_4_1.ImagSpec[i+1];
     end;
