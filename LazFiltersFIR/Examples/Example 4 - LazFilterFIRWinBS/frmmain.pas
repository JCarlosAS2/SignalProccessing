...
uses
  ...
  TATransformations, TADbSource, TALegendPanel, types, Math, UConst, FilterFirLPWin, FilterFirBSWin,
...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure FilterPropertiesBoxClick(Sender: TObject);
    ...
    procedure FloatSpinEditFreqCut2Change(Sender: TObject);
...
begin
  ...
  FloatSpinEditFreqCut2Change(nil);
...
begin
  FilterFIRBSWin1.Gain:= FloatSpinEditGain.Value;
end;

procedure TForm1.FloatSpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterFIRBSWin1.SampleRate:=FloatSpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
...
begin
    FilterFIRBSWin1.FreqCut1:= FloatSpinEditFreqCut1.Value;
end;

procedure TForm1.FloatSpinEditFreqCut2Change(Sender: TObject);
begin
   FilterFirBSWin1.FreqCut2:=FloatSpinEditFreqCut2.Value;
end;
...
begin
   ...
   case CBoxWin.ItemIndex of
    0 : FilterFIRBSWin1.WindowsType := WinBlackman1;
    1 : FilterFIRBSWin1.WindowsType := WinBlackmanHarris1;
    2 : FilterFIRBSWin1.WindowsType := WinNuttall1;
    3 : FilterFIRBSWin1.WindowsType := WinCos2_1;
    4 : FilterFIRBSWin1.WindowsType := WinHamming1;
    5 : FilterFIRBSWin1.WindowsType := WinHanning1;
    6 : FilterFIRBSWin1.WindowsType := WinKaiser1;
    7 : FilterFIRBSWin1.WindowsType := WinLanczos1;
    8 : FilterFIRBSWin1.WindowsType := WinTukey1;
    9 : FilterFIRBSWin1.WindowsType := WinGauss1;
   10 : FilterFIRBSWin1.WindowsType := WinFlatTop1;
   11 : FilterFIRBSWin1.WindowsType := WinBohman1;
   12 : FilterFIRBSWin1.WindowsType := WinBlackmanNuttall1;
   13 : FilterFIRBSWin1.WindowsType := WinParzen1;
   14 : FilterFIRBSWin1.WindowsType := WinRectangular1;
   15 : FilterFirBSWin1.WindowsType := WinTriangle1;
   ...
   FilterFirBSWin1.SetupFilter();
 end;



procedure TForm1.FilterPropertiesBoxClick(Sender: TObject);
begin
...
begin
   Timer1.Enabled:=false;
   FilterFIRBSWin1.Order:= SpinEditOrder.Value;
   SpinEditOrder.Value := FilterFIRBSWin1.Order; //Verificando visualmente el valor que realmente tomo la propiedad orden del filtro
   Timer1.Enabled := true;
end;
...
begin
  ...
  for I:= 1 to 5 do
  begin
    T:= Timer1.Tag / FilterFIRBSWin1.SampleRate;
    ...
    Series2.AddXY(T, FilterFIRBSWin1.Filter(V), '', clblue);
