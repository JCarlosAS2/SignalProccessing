...
begin
  FilterFIRHPWin1.Gain:= FloatSpinEditGain.Value;
end;

procedure TForm1.FloatSpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterFIRHPWin1.SampleRate:=FloatSpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
...
begin
    FilterFIRHPWin1.FreqCut1:= FloatSpinEditFreqCut1.Value;
end;
...
begin
   ...
   case CBoxWin.ItemIndex of
    0 : FilterFIRHPWin1.WindowsType := WinBlackman1;
    1 : FilterFIRHPWin1.WindowsType := WinTriangle1;
    2 : FilterFIRHPWin1.WindowsType := WinBlackmanHarris1;
    3 : FilterFIRHPWin1.WindowsType := WinNuttall1;
    4 : FilterFIRHPWin1.WindowsType := WinCos2_1;
    5 : FilterFIRHPWin1.WindowsType := WinHamming1;
    6 : FilterFIRHPWin1.WindowsType := WinHanning1;
    7 : FilterFIRHPWin1.WindowsType := WinKaiser1;
    8 : FilterFIRHPWin1.WindowsType := WinLanczos1;
    9 : FilterFIRHPWin1.WindowsType := WinTukey1;
   10 : FilterFIRHPWin1.WindowsType := WinGauss1;
   11 : FilterFIRHPWin1.WindowsType := WinFlatTop1;
   12 : FilterFIRHPWin1.WindowsType := WinBohman1;
   13 : FilterFIRHPWin1.WindowsType := WinBlackmanNuttall1;
   14 : FilterFIRHPWin1.WindowsType := WinParzen1;
   15 : FilterFIRHPWin1.WindowsType := WinRectangular1;
...
begin
   Timer1.Enabled:=false;
   FilterFIRHPWin1.Order:= SpinEditOrder.Value;
   SpinEditOrder.Value := FilterFIRHPWin1.Order; //Verificando visualmente el valor que realmente tomo la propiedad orden del filtro
   Timer1.Enabled := true;
end;
...
begin
  ...
  for I:= 1 to 5 do
  begin
    T:= Timer1.Tag / FilterFIRHPWin1.SampleRate;
    ...
    Series2.AddXY(T, FilterFIRHPWin1.Filter(V), '', clblue);
