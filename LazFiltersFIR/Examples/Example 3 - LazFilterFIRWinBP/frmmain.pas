...
begin
  FilterFIRBPWin1.Gain:= FloatSpinEditGain.Value;
end;

procedure TForm1.FloatSpinEditSampleRateChange(Sender: TObject);
begin
  Timer1.Enabled:=false;
  FilterFIRBPWin1.SampleRate:=FloatSpinEditSampleRate.Value;
  Series1.Clear;
  Series2.Clear;
  Timer1.Enabled:=true;
end;
...
begin
    FilterFIRBPWin1.FreqCut1:= FloatSpinEditFreqCut1.Value;
end;
...
begin
   ...
   case CBoxWin.ItemIndex of
    0 : FilterFIRBPWin1.WindowsType := WinBlackman1;
    1 : FilterFirBPWin1.WindowsType := WinTriangle1;
    2 : FilterFIRBPWin1.WindowsType := WinBlackmanHarris1;
    3 : FilterFIRBPWin1.WindowsType := WinNuttall1;
    4 : FilterFIRBPWin1.WindowsType := WinCos2_1;
    5 : FilterFIRBPWin1.WindowsType := WinHamming1;
    6 : FilterFIRBPWin1.WindowsType := WinHanning1;
    7 : FilterFIRBPWin1.WindowsType := WinKaiser1;
    8 : FilterFIRBPWin1.WindowsType := WinLanczos1;
    9 : FilterFIRBPWin1.WindowsType := WinTukey1;
   10 : FilterFIRBPWin1.WindowsType := WinGauss1;
   11 : FilterFIRBPWin1.WindowsType := WinFlatTop1;
   12 : FilterFIRBPWin1.WindowsType := WinBohman1;
   13 : FilterFIRBPWin1.WindowsType := WinBlackmanNuttall1;
   14 : FilterFIRBPWin1.WindowsType := WinParzen1;
   15 : FilterFIRBPWin1.WindowsType := WinRectangular1;
...
begin
  FilterFirBPWin1.FreqCut2:=FloatSpinEditFreqCut2.Value;
end;
...
begin
   Timer1.Enabled:=false;
   FilterFIRBPWin1.Order:= SpinEditOrder.Value;
   SpinEditOrder.Value := FilterFIRBPWin1.Order; //Verificando visualmente el valor que realmente tomo la propiedad orden del filtro
   Timer1.Enabled := true;
end;
...
begin
  ...
  for I:= 1 to 5 do
  begin
    T:= Timer1.Tag / FilterFIRBPWin1.SampleRate;
    ...
    Series2.AddXY(T, FilterFIRBPWin1.Filter(V), '', clblue);
